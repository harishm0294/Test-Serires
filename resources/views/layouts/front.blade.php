...
<head>
    ...
    <title>{{ config('app.name', 'Test Series') }}</title>

    
    <meta name="description" content="Test Series is an online system that allows you to conduct online test, We Support More than 100 Language. conduct exam like Maths, SSC , Bank , PO , RLY , JEE , JE, etc">
